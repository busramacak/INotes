...
class DataBaseHelper(context: Context):SQLiteOpenHelper(context,"note",null,3) {
    override fun onCreate(p0: SQLiteDatabase?) {
        p0?.execSQL("CREATE TABLE Notes (note_title TEXT, note TEXT,note_date TEXT, note_fav INTEGER);")
